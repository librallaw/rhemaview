        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h4>Upload Rhema Stars</h4>
                            @if(Session::has('success'))
                                <div class="alert alert-success">
                                    {{Session::get('success')}}
                                </div>
                            @endif
                            <form class="form-horizontal" method="post" action="{{ route('store_rhemastars') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label class="col-md-12">Article Image</label>
                                    <div class="col-md-12">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2017 &copy; Rhema</footer>
        </div>
            <!-- /#page-wrapper -->
        </div>
        <!-- /#wrapper -->

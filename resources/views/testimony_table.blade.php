                                ...
                                <table class="table table-striped table-responsive">
                                    ...
                                    <tr>
                                        @foreach($testimonies as $testimony)
                                            <td>{{$testimony->id}}</td>
                                            <td><img src="/img/{{$testimony->image}}" class="img-responsive" width="80px" height="80px"/></td>
                                            <td>{{$testimony->name}}</td>
                                            <td>{{$testimony->country}}</td>
                                            <td>{{$testimony->testimony}}</td>
                                            <td class="text-center">
                                                <div>{{$testimony->created_at}}</div>
                                            </td>
                                            <td class="text-center">{{$testimony->updated_at}}</td>
                                        @endforeach
                                    </tr>
                                    </tbody>
                                </table>

                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-responsive">
                                    ...
                                    <tbody>
                                    @foreach($rhemastars as $rhemastar)
                                    <tr>

                                            <td>{{$rhemastar->id}}</td>
                                            <td><img src="/img/{{$rhemastar->image}}" class="img-responsive" width="80px" height="80px"/></td>
                                            <td>{{$rhemastar->name}}</td>
                                            <td>{{$rhemastar->country}}</td>
                                            <td>{{$rhemastar->month}}</td>
                                            <td>{{$rhemastar->year}}</td>
                                            <td class="text-center">
                                                <div>{{$rhemastar->created_at}}</div>
                                            </td>
                                            <td class="text-center">{{$rhemastar->updated_at}}</td>

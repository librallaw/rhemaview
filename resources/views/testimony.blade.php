            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        @endif
                        <form class="form-horizontal" method="post" action="{{ route('create_testimony') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label class="col-md-12">Testimonies</label>
                                <div class="col-md-12">
                                    <textarea type="text" name="testimony" class="form-control"></textarea>
                                </div>
                            </div>
